...
int main() {
  std::string table_name = datasets::INSERT_2;
  {
  ...
  // Use compare_index to compare student's index to reference
  std::string cmd = std::string("build/Debug/bin/compare_index ") + table_name + " --mode page --keys 3";
